...
future rate-control path; the remaining larger big-values tables, true
polyphase/hybrid analysis, psychoacoustic scale-factor selection, and bit
reservoir integration are still pending.
