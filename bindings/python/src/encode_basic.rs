...
pub(crate) fn encode_wav(
    ...
    py.detach(move || encode_format(sample_rate, channels, samples, sonare_codec_rs::Format::Wav))
}
...
pub(crate) fn encode_mp3(
    ...
    py.detach(move || encode_format(sample_rate, channels, samples, sonare_codec_rs::Format::Mp3))
}
